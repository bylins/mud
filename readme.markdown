...
`keyword =` включает расширение `keyword`, раздел `[keyword]` указывает в каких файлах необходимо выполнять подстановки, связанные с интересующей нас информацией, и раздел `[keywordmaps]` указывает, правила подстановок.