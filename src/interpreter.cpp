...
cpp_extern const struct command_info cmd_info[] =
	{
		...
		{"север", kPosStanding, do_move, 0, SCMD_NORTH, -2},
		{"восток", kPosStanding, do_move, 0, SCMD_EAST, -2},
		{"юг", kPosStanding, do_move, 0, SCMD_SOUTH, -2},
		{"запад", kPosStanding, do_move, 0, SCMD_WEST, -2},
		{"вверх", kPosStanding, do_move, 0, SCMD_UP, -2},
		{"вниз", kPosStanding, do_move, 0, SCMD_DOWN, -2},
		{"north", kPosStanding, do_move, 0, SCMD_NORTH, -2},
		{"east", kPosStanding, do_move, 0, SCMD_EAST, -2},
		{"south", kPosStanding, do_move, 0, SCMD_SOUTH, -2},
		{"west", kPosStanding, do_move, 0, SCMD_WEST, -2},
		{"up", kPosStanding, do_move, 0, SCMD_UP, -2},
		{"down", kPosStanding, do_move, 0, SCMD_DOWN, -2},

		{"аффекты", kPosDead, do_affects, 0, SCMD_AUCTION, 0},
		{"авторы", kPosDead, do_gen_ps, 0, SCMD_CREDITS, 0},
		{"атаковать", kPosFighting, do_hit, 0, SCMD_MURDER, -1},
		{"аукцион", kPosResting, do_gen_comm, 0, SCMD_AUCTION, 100},
		{"анонсы", kPosDead, Boards::DoBoard, 1, Boards::NOTICE_BOARD, -1},

		{"базар", kPosResting, do_exchange, 1, 0, -1},
		{"баланс", kPosStanding, do_not_here, 1, 0, 0},
		{"баги", kPosDead, Boards::DoBoard, 1, Boards::ERROR_BOARD, 0},
		{"бежать", kPosFighting, do_flee, 1, 0, -1},
		{"бинтовать", kPosResting, do_bandage, 0, 0, 0},
		{"билдер", kPosDead, Boards::DoBoard, 1, Boards::GODBUILD_BOARD, -1},
		{"блок", kPosFighting, do_block, 0, 0, -1},
		{"блокнот", kPosDead, Boards::DoBoard, 1, Boards::PERS_BOARD, -1},
		{"боги", kPosDead, do_gen_ps, 0, SCMD_IMMLIST, 0},
		{"божества", kPosDead, Boards::DoBoard, 1, Boards::GODGENERAL_BOARD, -1},
		{"болтать", kPosResting, do_gen_comm, 0, SCMD_GOSSIP, -1},
		{"бонус", kPosDead, Bonus::do_bonus_by_character, kLevelImplementator, 0, 0},
		{"бонусинфо", kPosDead, Bonus::do_bonus_info, kLevelImplementator, 0, 0},
		{"бросить", kPosResting, do_drop, 0, SCMD_DROP, -1},
		{"варить", kPosResting, do_cook, 0, 0, 200},
		{"версия", kPosDead, do_gen_ps, 0, SCMD_VERSION, 0},
		{"вече", kPosDead, Boards::DoBoard, 1, Boards::GENERAL_BOARD, -1},
		{"взять", kPosResting, do_get, 0, 0, 200},
		{"взглянуть", kPosResting, do_diagnose, 0, 0, 100},
		{"взломать", kPosStanding, do_gen_door, 1, DOOR_SCMD::SCMD_PICK, -1},
		{"вихрь", kPosFighting, do_iron_wind, 0, 0, -1},
		{"вложить", kPosStanding, do_not_here, 1, 0, -1},
		{"вернуть", kPosStanding, do_not_here, 0, 0, -1},
		{"вернуться", kPosDead, do_return, 0, 0, -1},
		{"войти", kPosStanding, do_enter, 0, 0, -2},
		{"война", kPosResting, DoShowWars, 0, 0, 0},
		{"вооружиться", kPosResting, do_wield, 0, 0, 200},
		{"возврат", kPosResting, do_recall, 0, 0, -1},
		{"воззвать", kPosDead, do_pray_gods, 0, 0, -1},
		{"вплавить", kPosStanding, do_insertgem, 0, SKILL_INSERTGEM, -1},
		{"время", kPosDead, do_time, 0, 0, 0},
		{"врата", kPosSitting, do_townportal, 1, 0, -1},
		{"вскочить", kPosFighting, do_horseon, 0, 0, 500},
		{"встать", kPosResting, do_stand, 0, 0, 500},
		{"вспомнить", kPosDead, do_remember_char, 0, 0, 0},
		{"выбросить", kPosResting, do_drop, 0, 0 /*SCMD_DONATE */ , 300},
		{"выследить", kPosStanding, do_track, 0, 0, 500},
		{"вылить", kPosStanding, do_pour, 0, SCMD_POUR, 500},
		{"выходы", kPosResting, do_exits, 0, 0, 0},

		{"говорить", kPosResting, do_say, 0, 0, -1},
		{"ггруппа", kPosSleeping, do_gsay, 0, 0, 500},
		{"гговорить", kPosSleeping, do_gsay, 0, 0, 500},
		{"гдругам", kPosSleeping, DoClanChannel, 0, SCMD_CHANNEL, 0},
		{"где", kPosResting, do_where, kLevelImmortal, 0, 0},
		{"гдея", kPosResting, do_zone, 0, 0, 0},
		{"глоток", kPosResting, do_drink, 0, SCMD_SIP, 200},
		{"города", kPosDead, do_cities, 0, 0, 0},
		{"группа", kPosSleeping, do_group, 1, 0, -1},
		{"гсоюзникам", kPosSleeping, DoClanChannel, 0, SCMD_ACHANNEL, 0},
		{"гэхо", kPosDead, do_gecho, kLevelGod, 0, 0},
		{"гбогам", kPosDead, do_wiznet, kLevelImmortal, 0, 0},

		{"дать", kPosResting, do_give, 0, 0, 500},
		{"дата", kPosDead, do_date, 0, SCMD_DATE, 0},
		{"делить", kPosResting, do_split, 1, 0, 200},
		{"держать", kPosResting, do_grab, 0, 0, 300},
		{"дметр", kPosDead, do_dmeter, 0, 0, 0},
		{"доложить", kPosResting, do_report, 0, 0, 500},
		{"доски", kPosDead, Boards::DoBoardList, 0, 0, 0},
		{"дружины", kPosDead, DoClanList, 0, 0, 0},
		{"дрновости", kPosDead, Boards::DoBoard, 1, Boards::CLANNEWS_BOARD, -1},
		{"дрвече", kPosDead, Boards::DoBoard, 1, Boards::CLAN_BOARD, -1},
		{"дрлист", kPosDead, DoClanPkList, 0, 1, 0},
		//{"добавить", kPosDead, do_add_wizard, kLevelImplementator, 0, 0 },
		{"есть", kPosResting, do_eat, 0, SCMD_EAT, 500},

		{"жертвовать", kPosStanding, do_pray, 1, SCMD_DONATE, -1},

		{"заколоть", kPosStanding, do_backstab, 1, 0, 1},
		{"забыть", kPosResting, do_forget, 0, 0, 0},
		{"задержать", kPosStanding, do_not_here, 1, 0, -1},
		{"заклинания", kPosSleeping, do_spells, 0, 0, 0},
		{"заклстат", kPosDead, do_spellstat, kLevelGreatGod, 0, 0},
		{"закрыть", kPosSitting, do_gen_door, 0, SCMD_CLOSE, 500},
		{"замакс", kPosResting, do_show_mobmax, 1, 0, -1},
		{"замести", kPosStanding, do_hidetrack, 1, 0, -1},
		{"замолчать", kPosDead, do_wizutil, kLevelGod, SCMD_MUTE, 0},
		{"заморозить", kPosDead, do_wizutil, kLevelFreeze, SCMD_FREEZE, 0},
		{"занятость", kPosDead, do_check_occupation, kLevelGod, 0, 0},
		{"запомнить", kPosResting, do_memorize, 0, 0, 0},
		{"запереть", kPosSitting, do_gen_door, 0, SCMD_LOCK, 500},
		{"запрет", kPosDead, do_ban, kLevelGreatGod, 0, 0},
		{"заснуть", kPosSleeping, do_sleep, 0, 0, -1},
		{"заставка", kPosDead, do_gen_ps, 0, SCMD_MOTD, 0},
		{"заставить", kPosSleeping, do_force, kLevelGreatGod, 0, 0},
		{"затоптать", kPosStanding, do_extinguish, 0, 0, 0},
		{"заточить", kPosResting, do_upgrade, 0, 0, 500},
		{"заучить", kPosResting, do_memorize, 0, 0, 0},
		{"зачитать", kPosResting, do_employ, 0, SCMD_RECITE, 500},
		{"зачаровать", kPosStanding, do_spell_capable, 1, 0, 0},
		{"зачистить", kPosDead, do_sanitize, kLevelGreatGod, 0, 0},
		{"золото", kPosResting, do_gold, 0, 0, 0},
		{"зона", kPosResting, do_zone, 0, 0, 0},
		{"зоныстат", kPosDead, do_showzonestats, kLevelImmortal, 0, 0},
		{"инвентарь", kPosSleeping, do_inventory, 0, 0, 0},
		{"игнорировать", kPosDead, do_ignore, 0, 0, 0},
		{"идеи", kPosDead, Boards::DoBoard, 1, Boards::IDEA_BOARD, 0},
		{"изгнать нежить", kPosResting, do_turn_undead, 0, 0, -1},
		{"изучить", kPosSitting, do_learn, 0, 0, 0},
		{"информация", kPosSleeping, do_gen_ps, 0, SCMD_INFO, 0},
		{"испить", kPosResting, do_employ, 0, SCMD_QUAFF, 500},
		{"использовать", kPosResting, do_style, 0, 0, 0},
		{"имя", kPosSleeping, do_name, kLevelImmortal, 0, 0},

		{"колдовать", kPosSitting, do_cast, 1, 0, -1},
		{"казна", kPosResting, do_not_here, 1, 0, 0},
		{"карта", kPosResting, do_map, 0, 0, 0},
		{"клан", kPosResting, DoHouse, 0, 0, 0},
		{"клич", kPosFighting, do_warcry, 1, 0, -1},
		{"кодер", kPosDead, Boards::DoBoard, 1, Boards::CODER_BOARD, -1},
		{"команды", kPosDead, do_commands, 0, SCMD_COMMANDS, 0},
		{"коне", kPosSleeping, do_quit, 0, 0, 0},
		{"конец", kPosSleeping, do_quit, 0, SCMD_QUIT, 0},
		{"копать", kPosStanding, do_dig, 0, SKILL_DIG, -1},
		{"красться", kPosStanding, do_hidemove, 1, 0, -2},
		{"кричать", kPosResting, do_gen_comm, 0, SCMD_SHOUT, -1},
		{"кто", kPosResting, do_who, 0, 0, 0},
		{"ктодружина", kPosResting, DoWhoClan, 0, 0, 0},
		{"ктоя", kPosDead, do_gen_ps, 0, SCMD_WHOAMI, 0},
		{"купить", kPosStanding, do_not_here, 0, 0, -1},

		{"леваярука", kPosResting, do_grab, 1, 0, 300},
		{"лечить", kPosStanding, do_firstaid, 0, 0, -1},
		{"лить", kPosStanding, do_pour, 0, SCMD_POUR, 500},
		{"лошадь", kPosStanding, do_not_here, 1, 0, -1},
		{"лучшие", kPosDead, DoBest, 0, 0, 0},

		{"маскировка", kPosResting, do_camouflage, 0, 0, 500},
		{"магазины", kPosDead, do_shops_list, kLevelImmortal, 0, 0},
		{"метнуть", kPosFighting, do_throw, 0, SCMD_PHYSICAL_THROW, -1},
		{"менять", kPosStanding, do_not_here, 0, 0, -1},
		{"месть", kPosResting, do_revenge, 0, 0, 0},
		{"молот", kPosFighting, do_mighthit, 0, 0, -1},
		{"молиться", kPosStanding, do_pray, 1, SCMD_PRAY, -1},
		{"моястатистика", kPosDead, do_mystat, 0, 0, 0},
		{"мысл", kPosDead, do_quit, 0, 0, 0},
		{"мысль", kPosDead, Boards::report_on_board, 0, Boards::SUGGEST_BOARD, 0},

		{"наемник", kPosStanding, do_not_here, 1, 0, -1},
		{"наказания", kPosDead, Boards::DoBoard, 1, Boards::GODPUNISH_BOARD, -1},
		{"налить", kPosStanding, do_pour, 0, SCMD_FILL, 500},
		{"наполнить", kPosStanding, do_pour, 0, SCMD_FILL, 500},
		{"найти", kPosStanding, do_sense, 0, 0, 500},
		{"нанять", kPosStanding, do_findhelpee, 0, 0, -1},
		{"новичок", kPosSleeping, do_gen_ps, 0, SCMD_INFO, 0},
		{"новости", kPosDead, Boards::DoBoard, 1, Boards::NEWS_BOARD, -1},
		{"надеть", kPosResting, do_wear, 0, 0, 500},
		{"нацарапать", kPosResting, do_custom_label, 0, 0, 0},

		{"обезоружить", kPosFighting, do_disarm, 0, 0, -1},
		{"обернуться", kPosStanding, do_morph, 0, 0, -1},
		{"облачить", kPosResting, do_wear, 0, 0, 500},
		{"обмен", kPosStanding, do_not_here, 0, 0, 0},
		{"обменять", kPosStanding, do_not_here, 0, 0, 0},
		{"оглядеться", kPosResting, do_sides, 0, 0, 0},
		{"оглушить", kPosFighting, do_stupor, 0, 0, -1},
		{"одеть", kPosResting, do_wear, 0, 0, 500},
		{"опознать", kPosResting, do_identify, 0, 0, 500},
		{"опохмелиться", kPosResting, do_drunkoff, 0, 0, -1},
		{"опечатк", kPosDead, do_quit, 0, 0, 0},
		{"опечатка", kPosDead, Boards::report_on_board, 0, Boards::MISPRINT_BOARD, 0},
		{"опустить", kPosResting, do_put, 0, 0, 500},
		{"орать", kPosResting, do_gen_comm, 1, SCMD_HOLLER, -1},
		{"осмотреть", kPosResting, do_examine, 0, 0, 0},
		{"оседлать", kPosStanding, do_horsetake, 1, 0, -1},
		{"оскорбить", kPosResting, do_insult, 0, 0, -1},
		{"осушить", kPosResting, do_employ, 0, SCMD_QUAFF, 300},
		{"освежевать", kPosStanding, do_makefood, 0, 0, -1},
		{"ответить", kPosResting, do_reply, 0, 0, -1},
		{"отразить", kPosFighting, do_multyparry, 0, 0, -1},
		{"отвязать", kPosDead, do_horseget, 0, 0, -1},
		{"отдохнуть", kPosResting, do_rest, 0, 0, -1},
		{"открыть", kPosSitting, do_gen_door, 0, DOOR_SCMD::SCMD_OPEN, 500},
		{"отпереть", kPosSitting, do_gen_door, 0, SCMD_UNLOCK, 500},
		{"отпустить", kPosSitting, do_stophorse, 0, 0, -1},
		{"отравить", kPosFighting, do_poisoned, 0, 0, -1},
		{"отринуть", kPosResting, do_antigods, 1, 0, -1},
		{"отступить", kPosFighting, do_retreat, 1, 0, -1},
		{"отправить", kPosStanding, do_not_here, 1, 0, -1},
		{"оффтоп", kPosDead, do_offtop, 0, 0, -1},
		{"ошеломить", kPosStanding, do_stun, 1, 0, -1},
		{"оценить", kPosStanding, do_not_here, 0, 0, 500},
		{"очки", kPosDead, do_score, 0, 0, 0},
		{"очепятки", kPosDead, Boards::DoBoard, 1, Boards::MISPRINT_BOARD, 0},
		{"очистить", kPosDead, do_not_here, 0, SCMD_CLEAR, -1},
		{"ошибк", kPosDead, do_quit, 0, 0, 0},
		{"ошибка", kPosDead, Boards::report_on_board, 0, Boards::ERROR_BOARD, 0},

		{"парировать", kPosFighting, do_parry, 0, 0, -1},
		{"перехватить", kPosFighting, do_touch, 0, 0, -1},
		{"перековать", kPosStanding, do_transform_weapon, 0, SKILL_TRANSFORMWEAPON, -1},
		{"передать", kPosStanding, do_givehorse, 0, 0, -1},
		{"перевести", kPosStanding, do_not_here, 1, 0, -1},
		{"переместиться", kPosStanding, do_relocate, 1, 0, 0},
		{"перевоплотитьс", kPosStanding, do_remort, 0, 0, -1},
		{"перевоплотиться", kPosStanding, do_remort, 0, 1, -1},
		{"перелить", kPosStanding, do_pour, 0, SCMD_POUR, 500},
		{"перешить", kPosResting, do_fit, 0, SCMD_MAKE_OVER, 500},
		{"пить", kPosResting, do_drink, 0, SCMD_DRINK, 400},
		{"писать", kPosStanding, do_write, 1, 0, -1},
		{"пклист", kPosSleeping, DoClanPkList, 0, 0, 0},
		{"пнуть", kPosFighting, do_kick, 1, 0, -1},
		{"погода", kPosResting, do_weather, 0, 0, 0},
		{"подкрасться", kPosStanding, do_sneak, 1, 0, 500},
		{"подножка", kPosFighting, do_chopoff, 0, 0, 500},
		{"подняться", kPosResting, do_stand, 0, 0, -1},
		{"поджарить", kPosResting, do_fry, 0, 0, -1},
		{"перевязать", kPosResting, do_bandage, 0, 0, 0},
		{"переделать", kPosResting, do_fit, 0, SCMD_DO_ADAPT, 500},
		{"подсмотреть", kPosResting, do_look, 0, SCMD_LOOK_HIDE, 0},
		{"положить", kPosResting, do_put, 0, 0, 400},
		{"получить", kPosStanding, do_not_here, 1, 0, -1},
		{"политика", kPosSleeping, DoShowPolitics, 0, 0, 0},
		{"помочь", kPosFighting, do_assist, 1, 0, -1},
		{"помощь", kPosDead, do_help, 0, 0, 0},
		{"пометить", kPosDead, do_mark, kLevelImplementator, 0, 0},
		{"порез", kPosFighting, do_expedient_cut, 0, 0, -1},
		{"поселиться", kPosStanding, do_not_here, 1, 0, -1},
		{"постой", kPosStanding, do_not_here, 1, 0, -1},
		{"почта", kPosStanding, do_not_here, 1, 0, -1},
		{"пополнить", kPosStanding, do_refill, 0, 0, 300},
		{"поручения", kPosResting, do_quest, 1, 0, -1},
		{"появиться", kPosResting, do_visible, 1, 0, -1},
		{"правила", kPosDead, do_gen_ps, 0, SCMD_POLICIES, 0},
		{"предложение", kPosStanding, do_not_here, 1, 0, 500},
		//{"призвать", kPosStanding, do_summon, 1, 0, -1},
		{"приказ", kPosResting, do_order, 1, 0, -1},
		{"привязать", kPosResting, do_horseput, 0, 0, 500},
		{"приглядеться", kPosResting, do_looking, 0, 0, 250},
		{"прикрыть", kPosFighting, do_protect, 0, 0, -1},
		{"применить", kPosSitting, do_employ, 1, SCMD_USE, 400},
		//{"прикоснуться", kPosStanding, do_touch_stigma, 0, 0, -1},
		{"присесть", kPosResting, do_sit, 0, 0, -1},
		{"прислушаться", kPosResting, do_hearing, 0, 0, 300},
		{"присмотреться", kPosResting, do_looking, 0, 0, 250},
		{"придумки", kPosDead, Boards::DoBoard, 0, Boards::SUGGEST_BOARD, 0},
		{"проверить", kPosDead, do_check, 0, 0, 0},
		{"проснуться", kPosSleeping, do_wake, 0, SCMD_WAKE, -1},
		{"простить", kPosResting, do_forgive, 0, 0, 0},
		{"пробовать", kPosResting, do_eat, 0, SCMD_TASTE, 300},
		{"сожрать", kPosResting, do_eat, 0, SCMD_DEVOUR, 300},
		{"продать", kPosStanding, do_not_here, 0, 0, -1},
		{"фильтровать", kPosStanding, do_not_here, 0, 0, -1},
		{"прыжок", kPosSleeping, do_goto, kLevelGod, 0, 0},

		{"разбудить", kPosResting, do_wake, 0, SCMD_WAKEUP, -1},
		{"разгруппировать", kPosDead, do_ungroup, 0, 0, 500},
		{"разделить", kPosResting, do_split, 1, 0, 500},
		{"разделы", kPosResting, do_help, 1, 0, 500},
		{"разжечь", kPosStanding, do_fire, 0, 0, -1},
		{"распустить", kPosDead, do_ungroup, 0, 0, 500},
		{"рассмотреть", kPosStanding, do_not_here, 0, 0, -1},
		{"рассчитать", kPosResting, do_freehelpee, 0, 0, -1},
		{"режим", kPosDead, do_mode, 0, 0, 0},
		{"ремонт", kPosResting, do_repair, 0, 0, -1},
		{"рецепты", kPosResting, do_recipes, 0, 0, 0},
		{"рекорды", kPosDead, DoBest, 0, 0, 0},
		{"руны", kPosFighting, do_mixture, 0, SCMD_RUNES, -1},

		{"сбить", kPosFighting, do_bash, 1, 0, -1},
		{"свойства", kPosStanding, do_not_here, 0, 0, -1},
		{"сгруппа", kPosSleeping, do_gsay, 0, 0, -1},
		{"сглазить", kPosFighting, do_manadrain, 0, 0, -1},
		{"сесть", kPosResting, do_sit, 0, 0, -1},
		{"синоним", kPosDead, do_alias, 0, 0, 0},
		{"сдемигодам", kPosDead, do_sdemigod, kLevelImmortal, 0, 0},
		{"сказать", kPosResting, do_tell, 0, 0, -1},
		{"скользить", kPosStanding, do_lightwalk, 0, 0, 0},
		{"следовать", kPosResting, do_follow, 0, 0, 500},
		{"сложить", kPosFighting, do_mixture, 0, SCMD_RUNES, -1},
		{"слава", kPosStanding, Glory::do_spend_glory, 0, 0, 0},
		{"слава2", kPosStanding, GloryConst::do_spend_glory, 0, 0, 0},
		{"смотреть", kPosResting, do_look, 0, SCMD_LOOK, 0},
		{"смешать", kPosStanding, do_mixture, 0, SCMD_ITEMS, -1},
//  { "смастерить",     kPosStanding, do_transform_weapon, 0, SKILL_CREATEBOW, -1 },
		{"снять", kPosResting, do_remove, 0, 0, 500},
		{"создать", kPosSitting, do_create, 0, 0, -1},
		{"сон", kPosSleeping, do_sleep, 0, 0, -1},
		{"соскочить", kPosFighting, do_horseoff, 0, 0, -1},
		{"состав", kPosResting, do_create, 0, SCMD_RECIPE, 0},
		{"сохранить", kPosSleeping, do_save, 0, 0, 0},
		{"союзы", kPosResting, do_show_alliance, 0, 0, 0},
		{"социалы", kPosDead, do_commands, 0, SCMD_SOCIALS, 0},
		{"спать", kPosSleeping, do_sleep, 0, 0, -1},
		{"спасти", kPosFighting, do_rescue, 1, 0, -1},
		{"способности", kPosSleeping, do_features, 0, 0, 0},
		{"список", kPosStanding, do_not_here, 0, 0, -1},
		{"справка", kPosDead, do_help, 0, 0, 0},
		{"спросить", kPosResting, do_spec_comm, 0, SCMD_ASK, -1},
		{"спрятаться", kPosStanding, do_hide, 1, 0, 500},
		{"сравнить", kPosResting, do_consider, 0, 0, 500},
		{"ставка", kPosStanding, do_not_here, 0, 0, -1},
		{"статус", kPosDead, do_display, 0, 0, 0},
		{"статистика", kPosDead, do_statistic, 0, 0, 0},
		{"стереть", kPosDead, do_gen_ps, 0, SCMD_CLEAR, 0},
		{"стиль", kPosResting, do_style, 0, 0, 0},
		{"строка", kPosDead, do_display, 0, 0, 0},
		{"счет", kPosDead, do_score, 0, 0, 0},
		{"телега", kPosDead, do_telegram, 0, 0, -1},
		{"тень", kPosFighting, do_throw, 0, SCMD_SHADOW_THROW, -1},
		{"титул", kPosDead, TitleSystem::do_title, 0, 0, 0},
		{"трусость", kPosDead, do_wimpy, 0, 0, 0},
		{"убить", kPosFighting, do_kill, 0, 0, -1},
		{"убрать", kPosResting, do_remove, 0, 0, 400},
		{"ударить", kPosFighting, do_hit, 0, SCMD_HIT, -1},
		{"удавить", kPosFighting, do_strangle, 0, 0, -1},
		{"удалить", kPosStanding, do_delete_obj, kLevelImplementator, 0, 0},
		{"уклониться", kPosFighting, do_deviate, 1, 0, -1},
		{"украсть", kPosStanding, do_steal, 1, 0, 0},
		{"укрепить", kPosResting, do_armored, 0, 0, -1},
		{"умения", kPosSleeping, do_skills, 0, 0, 0},
		{"уровень", kPosDead, do_score, 0, 0, 0},
		{"уровни", kPosDead, do_levels, 0, 0, 0},
		{"учить", kPosStanding, do_not_here, 0, 0, -1},
		{"хранилище", kPosDead, DoStoreHouse, 0, 0, 0},
		{"характеристики", kPosStanding, do_not_here, 0, 0, -1},
		{"кланстаф", kPosStanding, do_clanstuff, 0, 0, 0},
		{"чинить", kPosStanding, do_not_here, 0, 0, -1},
		{"читать", kPosResting, do_look, 0, SCMD_READ, 200},
		{"шептать", kPosResting, do_spec_comm, 0, SCMD_WHISPER, -1},
		{"экипировка", kPosSleeping, do_equipment, 0, 0, 0},
		{"эмоция", kPosResting, do_echo, 1, SCMD_EMOTE, -1},
		{"эхо", kPosSleeping, do_echo, kLevelImmortal, SCMD_ECHO, -1},
		{"ярость", kPosResting, do_courage, 0, 0, -1},

		// God commands for listing
		{"мсписок", kPosDead, do_liblist, 0, SCMD_MLIST, 0},
		{"осписок", kPosDead, do_liblist, 0, SCMD_OLIST, 0},
		{"ксписок", kPosDead, do_liblist, 0, SCMD_RLIST, 0},
		{"зсписок", kPosDead, do_liblist, 0, SCMD_ZLIST, 0},

		{"'", kPosResting, do_say, 0, 0, -1},
		{":", kPosResting, do_echo, 1, SCMD_EMOTE, -1},
		{";", kPosDead, do_wiznet, kLevelImmortal, 0, -1},
		{"advance", kPosDead, do_advance, kLevelImplementator, 0, 0},
		{"alias", kPosDead, do_alias, 0, 0, 0},
		{"alter", kPosResting, do_fit, 0, SCMD_MAKE_OVER, 500},
		{"ask", kPosResting, do_spec_comm, 0, SCMD_ASK, -1},
		{"assist", kPosFighting, do_assist, 1, 0, -1},
		{"attack", kPosFighting, do_hit, 0, SCMD_MURDER, -1},
		{"auction", kPosResting, do_gen_comm, 0, SCMD_AUCTION, -1},
		{"arenarestore", kPosSleeping, do_arena_restore, kLevelGod, 0, 0},
		{"backstab", kPosStanding, do_backstab, 1, 0, 1},
		{"balance", kPosStanding, do_not_here, 1, 0, -1},
		{"ban", kPosDead, do_ban, kLevelGreatGod, 0, 0},
		{"bash", kPosFighting, do_bash, 1, 0, -1},
		{"beep", kPosDead, do_beep, kLevelImmortal, 0, 0},
		{"block", kPosFighting, do_block, 0, 0, -1},
		{"bug", kPosDead, Boards::report_on_board, 0, Boards::ERROR_BOARD, 0},
		{"buy", kPosStanding, do_not_here, 0, 0, -1},
		{"best", kPosDead, DoBest, 0, 0, 0},
		{"cast", kPosSitting, do_cast, 1, 0, -1},
		{"check", kPosStanding, do_not_here, 1, 0, -1},
		{"chopoff", kPosFighting, do_chopoff, 0, 0, 500},
		{"clear", kPosDead, do_gen_ps, 0, SCMD_CLEAR, 0},
		{"close", kPosSitting, do_gen_door, 0, SCMD_CLOSE, 500},
		{"cls", kPosDead, do_gen_ps, 0, SCMD_CLEAR, 0},
		{"commands", kPosDead, do_commands, 0, SCMD_COMMANDS, 0},
		{"consider", kPosResting, do_consider, 0, 0, 500},
		{"credits", kPosDead, do_gen_ps, 0, SCMD_CREDITS, 0},
		{"date", kPosDead, do_date, kLevelImmortal, SCMD_DATE, 0},
		{"dc", kPosDead, do_dc, kLevelGreatGod, 0, 0},
		{"deposit", kPosStanding, do_not_here, 1, 0, 500},
		{"deviate", kPosFighting, do_deviate, 0, 0, -1},
		{"diagnose", kPosResting, do_diagnose, 0, 0, 500},
		{"dig", kPosStanding, do_dig, 0, SKILL_DIG, -1},
		{"disarm", kPosFighting, do_disarm, 0, 0, -1},
		{"display", kPosDead, do_display, 0, 0, 0},
		{"drink", kPosResting, do_drink, 0, SCMD_DRINK, 500},
		{"drop", kPosResting, do_drop, 0, SCMD_DROP, 500},
		{"dumb", kPosDead, do_wizutil, kLevelImmortal, SCMD_DUMB, 0},
		{"eat", kPosResting, do_eat, 0, SCMD_EAT, 500},
		{"devour", kPosResting, do_eat, 0, SCMD_DEVOUR, 300},
		{"echo", kPosSleeping, do_echo, kLevelImmortal, SCMD_ECHO, 0},
		{"emote", kPosResting, do_echo, 1, SCMD_EMOTE, -1},
		{"enter", kPosStanding, do_enter, 0, 0, -2},
		{"equipment", kPosSleeping, do_equipment, 0, 0, 0},
		{"examine", kPosResting, do_examine, 0, 0, 500},
		{"exchange", kPosResting, do_exchange, 1, 0, -1},
		{"exits", kPosResting, do_exits, 0, 0, 500},
		{"featset", kPosSleeping, do_featset, kLevelImplementator, 0, 0},
		{"features", kPosSleeping, do_features, 0, 0, 0},
		{"fill", kPosStanding, do_pour, 0, SCMD_FILL, 500},
		{"fit", kPosResting, do_fit, 0, SCMD_DO_ADAPT, 500},
		{"flee", kPosFighting, do_flee, 1, 0, -1},
		{"follow", kPosResting, do_follow, 0, 0, -1},
		{"force", kPosSleeping, do_force, kLevelGreatGod, 0, 0},
		{"forcetime", kPosDead, do_forcetime, kLevelImplementator, 0, 0},
		{"freeze", kPosDead, do_wizutil, kLevelFreeze, SCMD_FREEZE, 0},
		{"gecho", kPosDead, do_gecho, kLevelGod, 0, 0},
		{"get", kPosResting, do_get, 0, 0, 500},
		{"give", kPosResting, do_give, 0, 0, 500},
		{"godnews", kPosDead, Boards::DoBoard, 1, Boards::GODNEWS_BOARD, -1},
		{"gold", kPosResting, do_gold, 0, 0, 0},
		{"glide", kPosStanding, do_lightwalk, 0, 0, 0},
		{"glory", kPosResting, GloryConst::do_glory, kLevelImplementator, 0, 0},
		{"glorytemp", kPosResting, do_glory, kLevelBuilder, 0, 0},
		{"gossip", kPosResting, do_gen_comm, 0, SCMD_GOSSIP, -1},
		{"goto", kPosSleeping, do_goto, kLevelGod, 0, 0},
		{"grab", kPosResting, do_grab, 0, 0, 500},
		{"group", kPosResting, do_group, 1, 0, 500},
		{"gsay", kPosSleeping, do_gsay, 0, 0, -1},
		{"gtell", kPosSleeping, do_gsay, 0, 0, -1},
		{"handbook", kPosDead, do_gen_ps, kLevelImmortal, SCMD_HANDBOOK, 0},
		{"hcontrol", kPosDead, DoHcontrol, kLevelGreatGod, 0, 0},
		{"help", kPosDead, do_help, 0, 0, 0},
		{"hell", kPosDead, do_wizutil, kLevelGod, SCMD_HELL, 0},
		{"hide", kPosStanding, do_hide, 1, 0, 0},
		{"hit", kPosFighting, do_hit, 0, SCMD_HIT, -1},
		{"hold", kPosResting, do_grab, 1, 0, 500},
		{"holler", kPosResting, do_gen_comm, 1, SCMD_HOLLER, -1},
		{"horse", kPosStanding, do_not_here, 0, 0, -1},
		{"house", kPosResting, DoHouse, 0, 0, 0},
		{"huk", kPosFighting, do_mighthit, 0, 0, -1},
		{"idea", kPosDead, Boards::DoBoard, 1, Boards::IDEA_BOARD, 0},
		{"ignore", kPosDead, do_ignore, 0, 0, 0},
		{"immlist", kPosDead, do_gen_ps, 0, SCMD_IMMLIST, 0},
		{"index", kPosResting, do_help, 1, 0, 500},
		{"info", kPosSleeping, do_gen_ps, 0, SCMD_INFO, 0},
		{"insert", kPosStanding, do_insertgem, 0, SKILL_INSERTGEM, -1},
		{"inspect", kPosDead, do_inspect, kLevelBuilder, 0, 0},
		{"insult", kPosResting, do_insult, 0, 0, -1},
		{"inventory", kPosSleeping, do_inventory, 0, 0, 0},
		{"invis", kPosDead, do_invis, kLevelGod, 0, -1},
		{"kick", kPosFighting, do_kick, 1, 0, -1},
		{"kill", kPosFighting, do_kill, 0, 0, -1},
		{"last", kPosDead, do_last, kLevelGod, 0, 0},
		{"levels", kPosDead, do_levels, 0, 0, 0},
		{"list", kPosStanding, do_not_here, 0, 0, -1},
		{"load", kPosDead, do_load, kLevelBuilder, 0, 0},
		{"loadstat", kPosDead, do_loadstat, kLevelImplementator, 0, 0},
		{"look", kPosResting, do_look, 0, SCMD_LOOK, 200},
		{"lock", kPosSitting, do_gen_door, 0, SCMD_LOCK, 500},
		{"map", kPosResting, do_map, 0, 0, 0},
		{"mail", kPosStanding, do_not_here, 1, 0, -1},
		{"mercenary", kPosStanding, do_not_here, 1, 0, -1},
		{"mode", kPosDead, do_mode, 0, 0, 0},
		{"mshout", kPosResting, do_mobshout, 0, 0, -1},
		{"motd", kPosDead, do_gen_ps, 0, SCMD_MOTD, 0},
		{"murder", kPosFighting, do_hit, 0, SCMD_MURDER, -1},
		{"mute", kPosDead, do_wizutil, kLevelImmortal, SCMD_MUTE, 0},
		{"medit", kPosDead, do_olc, 0, SCMD_OLC_MEDIT, 0},
		{"name", kPosDead, do_wizutil, kLevelGod, SCMD_NAME, 0},
		{"nedit", kPosResting, NamedStuff::do_named, kLevelBuilder, SCMD_NAMED_EDIT, 0}, //Именной стаф редактирование
		{"news", kPosDead, Boards::DoBoard, 1, Boards::NEWS_BOARD, -1},
		{"nlist", kPosResting, NamedStuff::do_named, kLevelBuilder, SCMD_NAMED_LIST, 0}, //Именной стаф список
		{"notitle", kPosDead, do_wizutil, kLevelGreatGod, SCMD_NOTITLE, 0},
		{"odelete", kPosStanding, do_delete_obj, kLevelImplementator, 0, 0},
		{"oedit", kPosDead, do_olc, 0, SCMD_OLC_OEDIT, 0},
		{"offer", kPosStanding, do_not_here, 1, 0, 0},
		{"olc", kPosDead, do_olc, kLevelGod, SCMD_OLC_SAVEINFO, 0},
		{"open", kPosSitting, do_gen_door, 0, SCMD_OPEN, 500},
		{"order", kPosResting, do_order, 1, 0, -1},
		{"overstuff", kPosDead, do_overstuff, kLevelGreatGod, 0, 0},
		{"page", kPosDead, do_page, kLevelGod, 0, 0},
		{"parry", kPosFighting, do_parry, 0, 0, -1},
		{"pick", kPosStanding, do_gen_door, 1, SCMD_PICK, -1},
		{"poisoned", kPosFighting, do_poisoned, 0, 0, -1},
		{"policy", kPosDead, do_gen_ps, 0, SCMD_POLICIES, 0},
		{"poofin", kPosDead, do_poofset, kLevelGod, SCMD_POOFIN, 0},
		{"poofout", kPosDead, do_poofset, kLevelGod, SCMD_POOFOUT, 0},
		{"pour", kPosStanding, do_pour, 0, SCMD_POUR, -1},
		{"practice", kPosStanding, do_not_here, 0, 0, -1},
		{"prompt", kPosDead, do_display, 0, 0, 0},
		{"proxy", kPosDead, do_proxy, kLevelGreatGod, 0, 0},
		{"purge", kPosDead, do_purge, kLevelGod, 0, 0},
		{"put", kPosResting, do_put, 0, 0, 500},
//	{"python", kPosDead, do_console, kLevelGod, 0, 0},
		{"quaff", kPosResting, do_employ, 0, SCMD_QUAFF, 500},
		{"qui", kPosSleeping, do_quit, 0, 0, 0},
		{"quit", kPosSleeping, do_quit, 0, SCMD_QUIT, -1},
		{"read", kPosResting, do_look, 0, SCMD_READ, 200},
		{"receive", kPosStanding, do_not_here, 1, 0, -1},
		{"recipes", kPosResting, do_recipes, 0, 0, 0},
		{"recite", kPosResting, do_employ, 0, SCMD_RECITE, 500},
		{"redit", kPosDead, do_olc, 0, SCMD_OLC_REDIT, 0},
		{"register", kPosDead, do_wizutil, kLevelImmortal, SCMD_REGISTER, 0},
		{"unregister", kPosDead, do_wizutil, kLevelImmortal, SCMD_UNREGISTER, 0},
		{"reload", kPosDead, do_reboot, kLevelImplementator, 0, 0},
		{"remove", kPosResting, do_remove, 0, 0, 500},
		{"rent", kPosStanding, do_not_here, 1, 0, -1},
		{"reply", kPosResting, do_reply, 0, 0, -1},
		{"report", kPosResting, do_report, 0, 0, -1},
		{"reroll", kPosDead, do_wizutil, kLevelGreatGod, SCMD_REROLL, 0},
		{"rescue", kPosFighting, do_rescue, 1, 0, -1},
		{"rest", kPosResting, do_rest, 0, 0, -1},
		{"restore", kPosDead, do_restore, kLevelGreatGod, SCMD_RESTORE_GOD, 0},
		{"return", kPosDead, do_return, 0, 0, -1},
		{"rset", kPosSleeping, do_rset, kLevelBuilder, 0, 0},
		{"rules", kPosDead, do_gen_ps, kLevelImmortal, SCMD_RULES, 0},
		{"runes", kPosFighting, do_mixture, 0, SCMD_RUNES, -1},
		{"save", kPosSleeping, do_save, 0, 0, 0},
		{"say", kPosResting, do_say, 0, 0, -1},
		{"scan", kPosResting, do_sides, 0, 0, 500},
		{"score", kPosDead, do_score, 0, 0, 0},
		{"sell", kPosStanding, do_not_here, 0, 0, -1},
		{"send", kPosSleeping, do_send, kLevelGreatGod, 0, 0},
		{"sense", kPosStanding, do_sense, 0, 0, 500},
		{"set", kPosDead, do_set, kLevelImmortal, 0, 0},
		{"settle", kPosStanding, do_not_here, 1, 0, -1},
		{"shout", kPosResting, do_gen_comm, 0, SCMD_SHOUT, -1},
		{"show", kPosDead, do_show, kLevelImmortal, 0, 0},
		{"shutdown", kPosDead, do_shutdown, kLevelImplementator, SCMD_SHUTDOWN, 0},
		{"sip", kPosResting, do_drink, 0, SCMD_SIP, 500},
		{"sit", kPosResting, do_sit, 0, 0, -1},
		{"skills", kPosResting, do_skills, 0, 0, 0},
		{"skillset", kPosSleeping, do_skillset, kLevelImplementator, 0, 0},
		{"morphset", kPosSleeping, do_morphset, kLevelImplementator, 0, 0},
		{"setall", kPosDead, do_setall, kLevelImplementator, 0, 0},
		{"sleep", kPosSleeping, do_sleep, 0, 0, -1},
		{"sneak", kPosStanding, do_sneak, 1, 0, -2},
		{"snoop", kPosDead, do_snoop, kLevelGreatGod, 0, 0},
		{"socials", kPosDead, do_commands, 0, SCMD_SOCIALS, 0},
		{"spells", kPosResting, do_spells, 0, 0, 0},
		{"split", kPosResting, do_split, 1, 0, 0},
		{"stand", kPosResting, do_stand, 0, 0, -1},
		{"stat", kPosDead, do_stat, kLevelGod, 0, 0},
		{"steal", kPosStanding, do_steal, 1, 0, 300},
		{"strangle", kPosFighting, do_strangle, 0, 0, -1},
		{"stupor", kPosFighting, do_stupor, 0, 0, -1},
		{"switch", kPosDead, do_switch, kLevelGreatGod, 0, 0},
		{"syslog", kPosDead, do_syslog, kLevelImmortal, SYSLOG, 0},
		{"suggest", kPosDead, Boards::report_on_board, 0, Boards::SUGGEST_BOARD, 0},
		{"slist", kPosDead, do_slist, kLevelImplementator, 0, 0},
		{"sedit", kPosDead, do_sedit, kLevelImplementator, 0, 0},
		{"errlog", kPosDead, do_syslog, kLevelBuilder, ERRLOG, 0},
		{"imlog", kPosDead, do_syslog, kLevelBuilder, IMLOG, 0},
		{"take", kPosResting, do_get, 0, 0, 500},
		{"taste", kPosResting, do_eat, 0, SCMD_TASTE, 500},
		{"t2c", kPosResting, do_send_text_to_char, kLevelGreatGod, 0, -1},
		{"telegram", kPosDead, do_telegram, kLevelImmortal, 0, -1},
		{"teleport", kPosDead, do_teleport, kLevelGreatGod, 0, -1},
		{"tell", kPosResting, do_tell, 0, 0, -1},
		{"time", kPosDead, do_time, 0, 0, 0},
		{"title", kPosDead, TitleSystem::do_title, 0, 0, 0},
		{"touch", kPosFighting, do_touch, 0, 0, -1},
		{"track", kPosStanding, do_track, 0, 0, -1},
		{"transfer", kPosStanding, do_not_here, 1, 0, -1},
		{"trigedit", kPosDead, do_olc, 0, SCMD_OLC_TRIGEDIT, 0},
		{"turn undead", kPosResting, do_turn_undead, 0, 0, -1},
		{"typo", kPosDead, Boards::report_on_board, 0, Boards::MISPRINT_BOARD, 0},
		{"unaffect", kPosDead, do_wizutil, kLevelGreatGod, SCMD_UNAFFECT, 0},
		{"unban", kPosDead, do_unban, kLevelGreatGod, 0, 0},
		{"unfreeze", kPosDead, do_unfreeze, kLevelImplementator, 0, 0},
		{"ungroup", kPosDead, do_ungroup, 0, 0, -1},
		{"unlock", kPosSitting, do_gen_door, 0, SCMD_UNLOCK, 500},
		{"uptime", kPosDead, do_date, kLevelImmortal, SCMD_UPTIME, 0},
		{"use", kPosSitting, do_employ, 1, SCMD_USE, 500},
		{"users", kPosDead, do_users, kLevelImmortal, 0, 0},
		{"value", kPosStanding, do_not_here, 0, 0, -1},
		{"version", kPosDead, do_gen_ps, 0, SCMD_VERSION, 0},
		{"visible", kPosResting, do_visible, 1, 0, -1},
		{"vnum", kPosDead, do_vnum, kLevelGreatGod, 0, 0},
		{"вномер", kPosDead, do_vnum, kLevelGreatGod, 0, 0},  //тупой копипаст для использования русского синтаксиса
		{"vstat", kPosDead, do_vstat, kLevelGreatGod, 0, 0},
		{"wake", kPosSleeping, do_wake, 0, 0, -1},
		{"warcry", kPosFighting, do_warcry, 1, 0, -1},
		{"wear", kPosResting, do_wear, 0, 0, 500},
		{"weather", kPosResting, do_weather, 0, 0, 0},
		{"where", kPosResting, do_where, kLevelImmortal, 0, 0},
		{"whirl", kPosFighting, do_iron_wind, 0, 0, -1},
		{"whisper", kPosResting, do_spec_comm, 0, SCMD_WHISPER, -1},
		{"who", kPosResting, do_who, 0, 0, 0},
		{"whoami", kPosDead, do_gen_ps, 0, SCMD_WHOAMI, 0},
		{"wield", kPosResting, do_wield, 0, 0, 500},
		{"wimpy", kPosDead, do_wimpy, 0, 0, 0},
		{"withdraw", kPosStanding, do_not_here, 1, 0, -1},
		{"wizhelp", kPosSleeping, do_commands, kLevelImmortal, SCMD_WIZHELP, 0},
		{"wizlock", kPosDead, do_wizlock, kLevelImplementator, 0, 0},
		{"wiznet", kPosDead, do_wiznet, kLevelImmortal, 0, 0},
		{"wizat", kPosDead, do_at, kLevelGreatGod, 0, 0},
		{"write", kPosStanding, do_write, 1, 0, -1},
		{"zedit", kPosDead, do_olc, 0, SCMD_OLC_ZEDIT, 0},
		{"zone", kPosResting, do_zone, 0, 0, 0},
		{"zreset", kPosDead, do_zreset, kLevelGreatGod, 0, 0},

		// test command for gods
		{"godtest", kPosDead, do_godtest, kLevelImplementator, 0, 0},
		{"armor", kPosDead, do_print_armor, kLevelImplementator, 0, 0},

		// Команды крафтинга - для тестига пока уровня имма
		{"mrlist", kPosDead, do_list_make, kLevelBuilder, 0, 0},
		{"mredit", kPosDead, do_edit_make, kLevelBuilder, 0, 0},
		{"сшить", kPosStanding, do_make_item, 0, MAKE_WEAR, 0},
		{"выковать", kPosStanding, do_make_item, 0, MAKE_METALL, 0},
		{"смастерить", kPosStanding, do_make_item, 0, MAKE_CRAFT, 0},

		// God commands for listing
		{"mlist", kPosDead, do_liblist, 0, SCMD_MLIST, 0},
		{"olist", kPosDead, do_liblist, 0, SCMD_OLIST, 0},
		{"rlist", kPosDead, do_liblist, 0, SCMD_RLIST, 0},
		{"zlist", kPosDead, do_liblist, 0, SCMD_ZLIST, 0},
		{"clist", kPosDead, do_liblist, kLevelGod, SCMD_CLIST, 0},

		{"attach", kPosDead, do_attach, kLevelImplementator, 0, 0},
		{"detach", kPosDead, do_detach, kLevelImplementator, 0, 0},
		{"tlist", kPosDead, do_tlist, 0, 0, 0},
		{"tstat", kPosDead, do_tstat, 0, 0, 0},
		{"vdelete", kPosDead, do_vdelete, kLevelImplementator, 0, 0},
		{"debug_queues", kPosDead, do_debug_queues, kLevelImplementator, 0, 0},
...
void command_interpreter(CharacterData *ch, char *argument) {
	...
	if (!social && GET_POS(ch) < cmd_info[cmd].minimum_position) {
		switch (GET_POS(ch)) {
			case kPosDead: send_to_char("Очень жаль - ВЫ МЕРТВЫ!!! :-(\r\n", ch);
				break;
			case kPosIncap:
			case kPosMortallyw: send_to_char("Вы в критическом состоянии и не можете ничего делать!\r\n", ch);
				break;
			case kPosStunned: send_to_char("Вы слишком слабы, чтобы сделать это!\r\n", ch);
				break;
			case kPosSleeping: send_to_char("Сделать это в ваших снах?\r\n", ch);
				break;
			case kPosResting: send_to_char("Нет... Вы слишком расслаблены...\r\n", ch);
				break;
			case kPosSitting: send_to_char("Пожалуй, вам лучше встать на ноги.\r\n", ch);
				break;
			case kPosFighting: send_to_char("Ни за что! Вы сражаетесь за свою жизнь!\r\n", ch);
				break;
