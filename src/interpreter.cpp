...
cpp_extern const struct command_info cmd_info[] =
{
	...
	{"�����", POS_DEAD, do_bonus, LVL_IMPL, 0, 0},
	...
	{"���������", POS_DEAD, do_check_occupation, LVL_GOD, 0, 0},
	...
	{"����������", POS_DEAD, do_sdemigod, LVL_IMMORT, 0, 0},
...
//  { "����������",     POS_STANDING, do_transform_weapon, 0, SKILL_CREATEBOW, -1 },
	...
	{ "�������", POS_STANDING, do_delete_obj, LVL_IMPL, 0, 0 },
...
//	{"python", POS_DEAD, do_console, LVL_GOD, 0, 0},
	...
	{"������", POS_DEAD, do_vnum, LVL_GRGOD, 0, 0},  //����� �������� ��� ������������� �������� ����������
...
// ������ �� ������� � ������ ����
	...
	if (new_char)
	{
		...
		SET_BIT(PRF_FLAGS(d->character, PRF_AUTOLOOT), PRF_AUTOLOOT); // �������
		SET_BIT(PRF_FLAGS(d->character, PRF_PKL_MODE), PRF_PKL_MODE); // ������
		SET_BIT(PRF_FLAGS(d->character, PRF_WORKMATE_MODE), PRF_WORKMATE_MODE); // ������
		...
		else
		{
			if (sscanf(arg, "%s %s", pwd_name, pwd_pwd) == 2)
			{
				...
				if (parse_exist_name(arg, tmp_name) ||
						strlen(tmp_name) < (MIN_NAME_LENGTH - 1) || // ���� ����� ���� ����� ����� � 4 �������
 ...
 */
	...
	case CON_RELIGION:	// query religion of new user
		...
		SEND_TO_Q("\r\n����� ��� ��� ����� ����� �� ����:\r\n", d);
		SEND_TO_Q(string(PlayerRace::ShowRacesMenu(GET_KIN(d->character))).c_str(), d);
		sprintf(buf, "��� ����� ���������� ������ ����� �������� %s", default_race[GET_CLASS(d->character)]);
		SEND_TO_Q(buf, d);
		SEND_TO_Q("\r\n�� ���� �� ������ : ", d);
		STATE(d) = CON_RACE;
		break;
