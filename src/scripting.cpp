...
BOOST_PYTHON_MODULE(constants)
{
    ...
    DEFINE_CONSTANT(CLASS_BASIC_NPC);
    DEFINE_CONSTANT(CLASS_HERO_WARRIOR);
    DEFINE_CONSTANT(CLASS_HERO_MAGIC);
    DEFINE_CONSTANT(CLASS_NPC_BATLEMAGE);
    DEFINE_CONSTANT(CLASS_LAST_NPC);
    ...
    DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_TAKE);
    DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_FINGER);
    DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_NECK);
    DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_BODY);
    DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_HEAD);
    DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_LEGS);
    DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_FEET);
    DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_HANDS);
    DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_ARMS);
    DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_SHIELD);
    DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_ABOUT);
    DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_WAIST);
	DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_WRIST);
	DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_WIELD);
	DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_HOLD);
	DEFINE_CONSTANT(EExtraFlags::ITEM_WEAR_BOTHS);
	DEFINE_CONSTANT(EExtraFlags::ITEM_GLOW);
	DEFINE_CONSTANT(EExtraFlags::ITEM_HUM);
	DEFINE_CONSTANT(EExtraFlags::ITEM_NORENT);
	DEFINE_CONSTANT(EExtraFlags::ITEM_NODONATE);
	DEFINE_CONSTANT(EExtraFlags::ITEM_NOINVIS);
	DEFINE_CONSTANT(EExtraFlags::ITEM_INVISIBLE);
    DEFINE_CONSTANT(EExtraFlags::ITEM_MAGIC);
	DEFINE_CONSTANT(EExtraFlags::ITEM_NODROP);
	DEFINE_CONSTANT(EExtraFlags::ITEM_BLESS);
	DEFINE_CONSTANT(EExtraFlags::ITEM_NOSELL);
	DEFINE_CONSTANT(EExtraFlags::ITEM_DECAY);
	DEFINE_CONSTANT(EExtraFlags::ITEM_ZONEDECAY);
	DEFINE_CONSTANT(EExtraFlags::ITEM_NODISARM);
	DEFINE_CONSTANT(EExtraFlags::ITEM_NODECAY);
	DEFINE_CONSTANT(EExtraFlags::ITEM_POISONED);
	DEFINE_CONSTANT(EExtraFlags::ITEM_SHARPEN);
	DEFINE_CONSTANT(EExtraFlags::ITEM_ARMORED);
    DEFINE_CONSTANT(EExtraFlags::ITEM_DAY);
	DEFINE_CONSTANT(EExtraFlags::ITEM_NIGHT);
	DEFINE_CONSTANT(EExtraFlags::ITEM_FULLMOON);
	DEFINE_CONSTANT(EExtraFlags::ITEM_WINTER);
	DEFINE_CONSTANT(EExtraFlags::ITEM_SPRING);
	DEFINE_CONSTANT(EExtraFlags::ITEM_SUMMER);
	DEFINE_CONSTANT(EExtraFlags::ITEM_AUTUMN);
	DEFINE_CONSTANT(EExtraFlags::ITEM_SWIMMING);
	DEFINE_CONSTANT(EExtraFlags::ITEM_FLYING);
	DEFINE_CONSTANT(EExtraFlags::ITEM_THROWING);
	DEFINE_CONSTANT(EExtraFlags::ITEM_TICKTIMER);
    DEFINE_CONSTANT(EExtraFlags::ITEM_FIRE);
	DEFINE_CONSTANT(EExtraFlags::ITEM_REPOP_DECAY);
	DEFINE_CONSTANT(EExtraFlags::ITEM_NOLOCATE);
	DEFINE_CONSTANT(EExtraFlags::ITEM_TIMEDLVL);
	DEFINE_CONSTANT(EExtraFlags::ITEM_NOALTER);
	DEFINE_CONSTANT(EExtraFlags::ITEM_WITH1SLOT);
	DEFINE_CONSTANT(EExtraFlags::ITEM_WITH2SLOTS);
	DEFINE_CONSTANT(EExtraFlags::ITEM_WITH3SLOTS);
	DEFINE_CONSTANT(EExtraFlags::ITEM_SETSTUFF);
	DEFINE_CONSTANT(EExtraFlags::ITEM_NO_FAIL);
	DEFINE_CONSTANT(EExtraFlags::ITEM_NAMED);
    DEFINE_CONSTANT(EExtraFlags::ITEM_BLOODY);
	DEFINE_CONSTANT(EExtraFlags::ITEM_1INLAID);
	DEFINE_CONSTANT(EExtraFlags::ITEM_2INLAID);
	DEFINE_CONSTANT(EExtraFlags::ITEM_3INLAID);
