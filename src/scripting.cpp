...
BOOST_PYTHON_MODULE (constants) {
	...
	DEFINE_CONSTANT(ERoomFlag::kDark);
	...
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_LIGHT);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_SCROLL);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_WAND);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_STAFF);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_WEAPON);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_FIREWEAPON);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_MISSILE);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_TREASURE);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_ARMOR);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_POTION);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_WORN);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_OTHER);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_TRASH);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_TRAP);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_CONTAINER);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_NOTE);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_DRINKCON);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_KEY);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_FOOD);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_MONEY);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_PEN);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_BOAT);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_FOUNTAIN);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_BOOK);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_INGREDIENT);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_MING);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_MATERIAL);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_BANDAGE);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_ARMOR_LIGHT);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_ARMOR_MEDIAN);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_ARMOR_HEAVY);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_ENCHANT);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_MAGIC_MATERIAL);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_MAGIC_ARROW);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_MAGIC_CONTAINER);
	DEFINE_ENUM_CONSTANT(EObjType::ITEM_CRAFT_MATERIAL);
	...
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_NONE);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_BULAT);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_BRONZE);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_IRON);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_STEEL);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_SWORDSSTEEL);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_COLOR);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_CRYSTALL);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_WOOD);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_SUPERWOOD);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_FARFOR);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_GLASS);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_ROCK);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_BONE);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_MATERIA);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_SKIN);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_ORGANIC);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_PAPER);
	DEFINE_ENUM_CONSTANT(EObjMaterial::MAT_DIAMOND);
