...
class ObjWrapper : private std::shared_ptr<ObjectData>, public Wrapper<ObjectData> {
 public:
	...
	void set_obj_type(const int v) {
		Ensurer obj(*this);
		obj->set_type(static_cast<ObjData::EObjectType>(v));
	}
	...
	void set_mater(const int v) {
		Ensurer obj(*this);
		obj->set_material(static_cast<ObjData::EObjectMaterial>(v));
	}
	int get_owner() const {
		Ensurer obj(*this);
...
BOOST_PYTHON_MODULE (constants) {
	...
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_LIGHT);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_SCROLL);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_WAND);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_STAFF);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_WEAPON);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_FIREWEAPON);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_MISSILE);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_TREASURE);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_ARMOR);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_POTION);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_WORN);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_OTHER);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_TRASH);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_TRAP);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_CONTAINER);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_NOTE);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_DRINKCON);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_KEY);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_FOOD);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_MONEY);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_PEN);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_BOAT);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_FOUNTAIN);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_BOOK);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_INGREDIENT);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_MING);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_MATERIAL);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_BANDAGE);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_ARMOR_LIGHT);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_ARMOR_MEDIAN);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_ARMOR_HEAVY);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_ENCHANT);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_MAGIC_MATERIAL);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_MAGIC_ARROW);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_MAGIC_CONTAINER);
	DEFINE_ENUM_CONSTANT(ObjData::ITEM_CRAFT_MATERIAL);
	...
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_NONE);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_BULAT);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_BRONZE);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_IRON);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_STEEL);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_SWORDSSTEEL);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_COLOR);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_CRYSTALL);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_WOOD);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_SUPERWOOD);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_FARFOR);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_GLASS);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_ROCK);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_BONE);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_MATERIA);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_SKIN);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_ORGANIC);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_PAPER);
	DEFINE_ENUM_CONSTANT(ObjData::EObjectMaterial::MAT_DIAMOND);
