...
class FormattersBuilder {
 public:
	static Board::Formatter::shared_ptr coder(std::ostringstream &out, CharacterData *character, const time_t &date);
	static Board::Formatter::shared_ptr news_and_godnews(std::ostringstream &out,
														 CharacterData *character,
														 const time_t &date);
	static Board::Formatter::shared_ptr clan_news(std::ostringstream &out, CharacterData *character, const time_t &date);
