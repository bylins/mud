...
int perform_set(CHAR_DATA * ch, CHAR_DATA * vict, int mode, char *val_arg)
{
	...
	case 41:		/* Blame/Thank Rick Glover. :) */
...
*/
	...
	case 57:      // Разрегистрация персонажа
		reason = one_argument(val_arg, num);
		if (num && *num) times=atol(num);
