...
inline bool CAN_SEE(const CHAR_DATA::shared_ptr &sub, const CHAR_DATA::shared_ptr &obj) {
...
inline int VPOSI_MOB(const CHAR_DATA::shared_ptr &ch, const int stat_id, const int val) {
