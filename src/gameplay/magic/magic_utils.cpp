...
float PotionPotency(const ObjData *potion, ESpell spell_id) {
	const int skill = potion->GetPotionValueKey(ObjVal::EValueKey::kMakerSkill);
	...
	const int stat = potion->GetPotionValueKey(ObjVal::EValueKey::kMakerStat);
...
int PotionCastSkill(const ObjData *potion) {
	const int stored = potion->GetPotionValueKey(ObjVal::EValueKey::kMakerSkill);
...
int PotionCastStat(const ObjData *potion) {
	const int stored = potion->GetPotionValueKey(ObjVal::EValueKey::kMakerStat);
