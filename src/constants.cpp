...
const char *cast_phrase[SPELLS_COUNT + 1][2] = { {"\nRESERVED DB.C",	// 0
	...
	{"ажбо супостаты блазнити да клюковати",
	 ...
	 {"\n",
	 "\n"}, // SPELL_VAMPIRE
	 {"Надели силою своею Навь, дабы собрать урожай тебе.", 
	 ".. Воззри на предмет сей Отче и верни ему силу прежнюю."}, // SPELLS_RESTORATION
	 {"Да убоятся вороги нас.",
	 "...налякай ворогов наших и покарай их немощью."}, // SPELL_AURA_DEATH
	 {"Обрасти плотью сызнова.",
	 "... прости Господи грехи, верни плоть созданию."}, // SPELL_RECOVERY
	 {"Обрастите плотью сызнова.",
	 "... прости Господи грехи, верни плоть созданиям."}, // SPELL_MASS_RECOVERY
	 {"Возьми личину зла для жатвы славной.",
	 "Надели силой злою во благо."}, // SPELL_AURA_EVIL
};
