...
/* SECT_ */
const char *sector_types[] = { "Гладкий пол",
	"Улица",
	"Поле",
	"Лес",
	"Холмы",
...
const char *race_name[NUM_RACES][NUM_SEXES] = { {"Северне", "Северянин", "Северянка", "Северяне"},
...
{"Половцы","Половец","Половка","Половцы"},
{"Печенеги","Печенег","Печенежка","Печенеги"},
{"Монголы","Монгол","Монголка","Монголы"},
{"Уйгуры","Уйгур","Уйгурка","Уйгуры"},
{"Кангары","Кангарин","Кангарка","Кангары"},
{"Хазары","Хазарин","Хазарка","Хазары"},
{"Свеи","Свеи","Свеика","Свеи"},
{"Датчане","Датчанин","Датчанка","Датчане"},
{"Гетты","Гетт","Геттка","Гетты"},
{"Ютты","Ютт","Юттка","Ютты"},
{"Халейги","Халейг","Халейжка","Халейги"},
{"Норвежцы","Норвежец","Норвежка","Норвежцы"}
};

const char *kin_name[NUM_KIN][NUM_SEXES] = { {"Русичи", "Русич", "Русич", "Русичи"},
{"Викинги", "Викинг", "Викинг", "Викинги"},
{"Степняки", "Степняк", "Степнячка", "Степняки"},
};
...
/* WEAR_x - for stat */
char *equipment_types[] = { "использует для освещения",
...
{(struct extra_affects_type *) &PolovciAffects,
 (struct obj_affected_type *) &PolovciModifiers},
{(struct extra_affects_type *) &PechenegiAffects,
 (struct obj_affected_type *) &PechenegiModifiers},
{(struct extra_affects_type *) &MongoliAffects,
 (struct obj_affected_type *) &MongoliModifiers},
{(struct extra_affects_type *) &YiguriAffects,
 (struct obj_affected_type *) &YiguriModifiers},
{(struct extra_affects_type *) &KangariAffects,
 (struct obj_affected_type *) &KangariModifiers},
{(struct extra_affects_type *) &XazariAffects,
 (struct obj_affected_type *) &XazariModifiers},
{(struct extra_affects_type *) &SveiAffects,
 (struct obj_affected_type *) &SveiModifiers},
{(struct extra_affects_type *) &DatchaneAffects,
 (struct obj_affected_type *) &DatchaneModifiers},
{(struct extra_affects_type *) &GettiAffects,
 (struct obj_affected_type *) &GettiModifiers},
{(struct extra_affects_type *) &UttiAffects,
 (struct obj_affected_type *) &UttiModifiers},
{(struct extra_affects_type *) &XaleigiAffects,
 (struct obj_affected_type *) &XaleigiModifiers},
{(struct extra_affects_type *) &NorvezciAffects,
 (struct obj_affected_type *) &NorvezciModifiers}
};
...
"Шоб вас приподняло да шлепнуло!!!"}, /* коич грома */
...
{"Сарынь на кичку!",
"Сарынь на кичку!!!"},
{"Стоять крепко!  нами Киев, Подол и трактир с пивом!!!",
...
{16, "День Перенесения мощей Николая (Чудотворца)", 9, 5, 1, 0x0002},
...
{				//{1,"Обрезание господне",1,1,1,0x0002},
	...
	//{16,"Перенесения мощей Николая (Чудотворца)",9,5,1,0x0002},
	//{17,"Вознесение",40,DAY_EASTER,1,0x0002},
	//{18,"Троицкая родительская суббота",48,DAY_EASTER,1,0x0002},
	//{19,"Святая троица, 1й день",49,DAY_EASTER,1,0x0002},
	//{20,"Святая троица, День святого духа",50,DAY_EASTER,1,0x0002},
...
int mana_cost_cs[][9] = {	/* Круг
				   1й   2й   3й   4й   5й   6й   7й   8й   9й */
