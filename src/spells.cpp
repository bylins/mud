...
const cast_phrases_t cast_phrase =
{
	...
	cast_phrase_t{ "массмигалка", "..массмигалка"}, //массмигалка
	cast_phrase_t{ "массзатуманка", "... массзатуманка."}, //массзатуманка
	cast_phrase_t{ "массвнималка", "... массвнималка."}, //массвнималка
};
