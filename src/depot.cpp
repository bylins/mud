...
const char *HELP_FORMAT =
	...
	"осмотреть сундук, положить меч сундук, взять меч сундук, смотреть короб, взять все короб и т.д.\r\n"
	"Походный сундучок - Ваше личное хранилище (до 25 предметов).\r\n"
	"Короб - хранилище для одновременного использования несколькими персонажами (до 1к предметов).\r\n"
	"- за предметы в вашем персональном хранилище плата снимается только когда вы не в игре.\r\n"
	"- за предметы в коробе плата снимается постоянно (только за вашу часть предметов).\r\n"
