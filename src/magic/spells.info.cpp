...
//5
	initSpell(SPELL_BURNING_HANDS,
			  ...
			  MTYPE_AGGRESSIVE,
			  MAG_AREAS | MAG_DAMAGE | NPC_DAMAGE_PC,
			  1,
			  STYPE_FIRE);
//6
	initSpell(SPELL_CALL_LIGHTNING,
			  "шаровая молния",
			  "call lightning",
			  85,
			  70,
			  ...
			  TAR_CHAR_ROOM | TAR_FIGHT_VICT,
			  MTYPE_AGGRESSIVE,
			  NPC_AFFECT_PC | MAG_AFFECTS | MAG_DAMAGE | NPC_DAMAGE_PC,
			  2,
			  STYPE_AIR);
//7
...
//10
	initSpell(SPELL_COLOR_SPRAY,
			  ...
			  TAR_CHAR_ROOM | TAR_FIGHT_VICT,
			  MTYPE_AGGRESSIVE,
			  MAG_AREAS | MAG_DAMAGE | NPC_DAMAGE_PC | NPC_DAMAGE_PC_MINHP,
			  3,
			  STYPE_WATER);
//11
...
//72
	initSpell(SPELL_ACID,
			  ...
			  TAR_CHAR_ROOM | TAR_FIGHT_VICT,
			  MTYPE_NEUTRAL,
			  MAG_DAMAGE | MAG_ALTER_OBJS | NPC_DAMAGE_PC,
			  2,
			  STYPE_WATER);
//73
...
//104
	initSpell(SPELL_CONE_OF_COLD,
			  ...
			  TAR_CHAR_ROOM | TAR_FIGHT_VICT,
			  MTYPE_AGGRESSIVE,
			  MAG_AFFECTS | MAG_DAMAGE | NPC_DAMAGE_PC | NPC_DAMAGE_PC_MINHP,
			  15,
			  STYPE_WATER);
//105
