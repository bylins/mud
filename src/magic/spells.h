...
enum ESpell : int {
	...
	SPELL_ROOM_LIGHT = 166,
	SPELL_POISONED_FOG = 167,
	SPELL_THUNDERSTORM = 168,
	...
	SPELL_SOLOBONUS = 201,
	SPELL_VAMPIRE = 202,
	SPELLS_RESTORATION = 203,
	SPELL_AURA_DEATH = 204,
	SPELL_RECOVERY = 205,
	SPELL_MASS_RECOVERY = 206,
	SPELL_AURA_EVIL = 207,
	SPELL_MENTAL_SHADOW = 208,
	SPELL_EVARDS_BLACK_TENTACLES = 209,
	SPELL_WHIRLWIND = 210,
	SPELL_INDRIKS_TEETH = 211,
	SPELL_MELFS_ACID_ARROW = 212,
	SPELL_THUNDERSTONE = 213,
	SPELL_CLOD = 214,
	SPELL_EXPEDIENT = 215,
	SPELL_SIGHT_OF_DARKNESS = 216,
	SPELL_GENERAL_SINCERITY = 217,
	SPELL_MAGICAL_GAZE = 218,
	SPELL_ALL_SEEING_EYE = 219,
	SPELL_EYE_OF_GODS = 220,
	SPELL_BREATHING_AT_DEPTH = 221,
	SPELL_GENERAL_RECOVERY = 222,
	SPELL_COMMON_MEAL = 223,
	SPELL_STONE_WALL = 224,
	SPELL_SNAKE_EYES = 225,
	SPELL_EARTH_AURA = 226,
	SPELL_GROUP_PROT_FROM_EVIL = 227,
	SPELL_ARROWS_FIRE = 228,
	SPELL_ARROWS_WATER = 229,
	SPELL_ARROWS_EARTH = 230,
	SPELL_ARROWS_AIR = 231,
	SPELL_ARROWS_DEATH = 232,
	SPELL_PALADINE_INSPIRATION = 233,
	SPELL_DEXTERITY = 234,
	SPELL_GROUP_BLINK = 235,
	SPELL_GROUP_CLOUDLY = 236,
	SPELL_GROUP_AWARNESS = 237,
	SPELL_WC_EXPERIENSE = 238,
	SPELL_WC_LUCK = 239,
	SPELL_WC_PHYSDAMAGE = 240,
	SPELL_MASS_FAILURE = 241,
	SPELL_MASS_NOFLEE = 242,
	SPELL_FIRE_BREATH = 243,
	SPELL_GAS_BREATH = 244,
	SPELL_FROST_BREATH = 245,
	SPELL_ACID_BREATH = 246,
	SPELL_LIGHTNING_BREATH = 247,
	SPELL_IDENTIFY = 351,
