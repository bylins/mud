...
#define GET_OBJ_POLY_1(ch, obj) ((GET_OBJ_SEX(obj) == SEX_POLY) ? "��" : "��")
#define GET_OBJ_VIS_POLY_1(ch, obj) (!CAN_SEE_OBJ(ch,obj) ? "��" : (GET_OBJ_SEX(obj) == SEX_POLY) ? "��" : "��")
...
#define HSHR(ch) (GET_SEX(ch) ? (IS_MALE(ch) ? "���": (IS_FEMALE(ch) ? "��" : "��")) :"���")
#define HSSH(ch) (GET_SEX(ch) ? (IS_MALE(ch) ? "��": (IS_FEMALE(ch) ? "���" : "���")) :"���")
#define HMHR(ch) (GET_SEX(ch) ? (IS_MALE(ch) ? "���": (IS_FEMALE(ch) ? "��" : "��")) :"���")
#define HYOU(ch) (GET_SEX(ch) ? (IS_MALE(ch) ? "���": (IS_FEMALE(ch) ? "����" : (IS_NOSEXY(ch) ? "����": "����"))) :"���")
...
#define OYOU(ch) (GET_OBJ_SEX(ch) ? (GET_OBJ_SEX(ch)==SEX_MALE ? "���": (GET_OBJ_SEX(ch) == SEX_FEMALE ? "����" : "����")) :"����")
