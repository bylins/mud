...
struct TechniqueItem {
	...
	TechniqueItem(short objectWearPosition, ObjectData::EObjectType objectType) :
		_wearPosition{objectWearPosition} {
		_type = objectType;
	};
	TechniqueItem(short objectWearPosition, ObjectData::EObjectType objectType, ESkill objectSkill) :
		TechniqueItem(objectWearPosition, objectType) {
		_skill = objectSkill;
	};
	TechniqueItem(short objectWearPosition, ObjectData::EObjectType objectType, ESkill objectSkill, EExtraFlag flag) :
