...
struct IndexData {
	IndexData() : vnum(0), CountInWorld(0), stored(0), func(nullptr), farg(nullptr), proto(nullptr), zone(0), set_idx(-1) {}
	IndexData(int _vnum)
		: vnum(_vnum), CountInWorld(0), stored(0), func(nullptr), farg(nullptr), proto(nullptr), zone(0), set_idx(-1) {}

	int vnum;            // virtual number of this mob/obj       //
	int CountInWorld;        // number of existing units of this mob/obj //
