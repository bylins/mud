...
namespace ExtMoney {
const unsigned TORC_GOLD = 0;		// золотые гривны
const unsigned TORC_SILVER = 1;		// серебряные гривны
const unsigned TORC_BRONZE = 2;		// бронзовые гривны
const unsigned TOTAL_TYPES = 3;		// терминатор всегда в конце
} // namespace ExtMoney
