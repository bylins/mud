 ...
 *  от вспомогательных , которые тоже могут быть в файле, (например - список ассортиментов
 *  в конфиге магазинов) и каждый набор данных передать в соответствующий парсер/билдер.
 */
class ICfgLoader {
 public:
