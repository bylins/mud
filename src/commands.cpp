...
class CommandEmbranchmentImplementation : public CommandEmbranchment {
 ...
 private:
	...
	void unexpected_branch(const CommandContext::shared_ptr &context,
						   const arguments_t &path,
...
CommandEmbranchment &CommandEmbranchmentImplementation::add_command(const std::string &branch,
																	const branch_t &command) {
...
void CommandEmbranchmentImplementation::execute(const CommandContext::shared_ptr &context,
												const arguments_t &path,
...
void CommandEmbranchmentImplementation::execution_without_arguments(const CommandContext::shared_ptr &context,
																	const arguments_t &path) const {
	if (m_noargs_handler) {
...
void CommandEmbranchmentImplementation::unexpected_branch(const CommandContext::shared_ptr &context,
														  const arguments_t &path,
														  const arguments_t &arguments) const {
...
void CommandEmbranchmentImplementation::make_suggestion(const CommandContext::shared_ptr &context,
														const std::string &wrong_subcommand) const {
