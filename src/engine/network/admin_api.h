/**
 \file admin_api.h
 \brief Admin API через Unix Domain Socket
 \details Предоставляет JSON-based API для управления миром через Unix-сокет.
          Включается только при компиляции с -DENABLE_ADMIN_API=ON
*/
