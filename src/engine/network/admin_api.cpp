...
std::string koi8r_to_utf8(const std::string &koi8r) {
	...
	log("koi8rБ├▓utf8 IN: [%s] hex:%s", koi8r_buf, hex_before.c_str());
	...
	log("koi8rБ├▓utf8 OUT: [%s] hex:%s", utf8_buf, hex_after.c_str());
...
std::string utf8_to_koi8r(const std::string &utf8) {
	...
	log("utf8Б├▓koi8r IN: [%s] hex:%s", utf8_buf, hex_before.c_str());
	...
	log("utf8Б├▓koi8r OUT: [%s] hex:%s", koi8r_buf, hex_after.c_str());
...
void admin_api_create_object(DescriptorData *d, int zone_vnum, const char *json_data) {
	...
	try {
		...
		auto &obj = temp_d->olc->obj;
		obj->set_aliases("О©╫О©╫О©╫О©╫О©╫ О©╫О©╫О©╫О©╫О©╫О©╫О©╫");
		obj->set_description("О©╫О©╫О©╫-О©╫О©╫ О©╫О©╫О©╫О©╫О©╫ О©╫О©╫О©╫О©╫О©╫ О©╫О©╫О©╫О©╫О©╫");
		obj->set_short_description("О©╫О©╫О©╫О©╫О©╫ О©╫О©╫О©╫О©╫О©╫О©╫О©╫");
		obj->set_PName(ECase::kNom, "О©╫О©╫О©╫ О©╫О©╫О©╫");
		obj->set_PName(ECase::kGen, "О©╫О©╫О©╫О©╫ О©╫О©╫О©╫О©╫");
		obj->set_PName(ECase::kDat, "О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫ О©╫ О©╫О©╫О©╫О©╫");
		obj->set_PName(ECase::kAcc, "О©╫О©╫О©╫О©╫О©╫ О©╫О©╫О©╫");
		obj->set_PName(ECase::kIns, "О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫ О©╫О©╫О©╫");
		obj->set_PName(ECase::kPre, "О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫ О©╫ О©╫О©╫О©╫");
