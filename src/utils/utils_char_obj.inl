...
inline bool INVIS_OK_OBJ(const CharacterData *sub, const ObjectData *obj) {
	return !obj->get_extra_flag(EExtraFlag::ITEM_INVISIBLE)
		|| AFF_FLAGGED(sub, EAffectFlag::AFF_DETECT_INVIS);
}

inline bool MORT_CAN_SEE_OBJ(const CharacterData *sub, const ObjectData *obj) {
...
inline bool CAN_SEE_OBJ(const CharacterData *sub, const ObjectData *obj) {
...
inline const char *OBJN(const ObjectData *obj, const CharacterData *vict, const size_t pad) {
...
inline const char *OBJS(const ObjectData *obj, const CharacterData *vict) {
	return CAN_SEE_OBJ(vict, obj) ? obj->get_short_description().c_str() : "что-то";
}

inline bool CAN_GET_OBJ(const CharacterData *ch, const ObjectData *obj) {
