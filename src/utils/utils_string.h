...
// Отличий от isname два: разделителями тут считаются только пробел, точка и подчёркивание
// (isname режет по любому не-буквенно-цифровому знаку, в том числе по дефису), и пустой abbr
// совпадает с чем угодно, тогда как isname на пустой запрос отвечает "нет".
