...
//
// Разделитель слов -- точка (и подчёркивание, и пробел). Дефис им НЕ считается, в отличие от
// isname, который режет по любому не-буквенно-цифровому знаку -- это ещё дикумадовское. На
// дефисных именах вроде "веер шань-цзы" разница видна: isname находит по "цзы", здесь "цзы"
// не префикс слова "шань-цзы" и совпадения нет. Предметы и персонажей ищет isname, так что
// игрока это не касается, но при переносе поиска на std::string помнить стоит.
//
