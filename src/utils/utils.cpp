...
const char *some_pads[3][38] =
	{
		{"дней", "часов", "лет", "очков", "минут", "минут", "кун", "кун", "штук", "штук", "уровней", "верст", "верст",
		 ...
		 "бронзовых", "гривен", "золотых", "серебряных", "бронзовых", "искристых снежинок"},
		{"день", "час", "год", "очко", "минута", "минуту", "куна", "куну", "штука", "штуку", "уровень", "верста",
		 ...
		 "бронзовая", "гривну", "золотую", "серебряную", "бронзовую", "искристую снежинку"},
		{"дня", "часа", "года", "очка", "минуты", "минуты", "куны", "куны", "штуки", "штуки", "уровня", "версты",
		 ...
		 "серебряные", "бронзовые", "гривны", "золотые", "серебряные", "бронзовые", "искристые снежинки"}
	};
...
bool ParseFilter::check_realtime(exchange_item_data *exch_obj) const {
	...
	if (new_timesign == '\0')
		...
		&& (new_timeup >= GET_EXCHANGE_ITEM_TIME(exch_obj)))
		result = true;
