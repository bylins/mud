...
void dam_message(int dam, CHAR_DATA * ch, CHAR_DATA * victim, int w_type)
{
	...
	static struct dam_weapon_type {
...

		{
			...
			"$n БОЛЬНО #w$g $N3.",	/*  36..50   8 */
			"Вы БОЛЬНО #wи $N3.",
			"$n БОЛЬНО #w$g Вас."
		}, {
			"$n ОЧЕНЬ БОЛЬНО #w$g $N3.",	/*    51..80  9  */
			"Вы ОЧЕНЬ БОЛЬНО #wи $N3.",
			"$n ОЧЕНЬ БОЛЬНО #w$g Вас."
		}, {
			"$n ЧРЕЗВЫЧАЙНО БОЛЬНО #w$g $N3.",	/*    81..110  10 */
			"Вы ЧРЕЗВЫЧАЙНО БОЛЬНО #wи $N3.",
			"$n ЧРЕЗВЫЧАЙНО БОЛЬНО #w$g Вас."
		}, {
			"$n НЕВЫНОСИМО БОЛЬНО #w$g $N3.",	/*    111..140  11 */
			"Вы НЕВЫНОСИМО БОЛЬНО #wи $N3.",
			"$n НЕВЫНОСИМО БОЛЬНО #w$g Вас."
		}, {
			"$n С НЕВИДАННОЙ СИЛОЙ #w$g $N3.",	/*    141..170  12 */
			"Вы С НЕВИДАННОЙ СИЛОЙ #wи $N3.",
			"$n С НЕВИДАННОЙ СИЛОЙ #w$g Вас."
		}, {
			"$n С УЖАСАЮЩЕЙ СИЛОЙ #w$g $N3.",	/*    171..200  13 */
			"Вы С УЖАСАЮЩЕЙ СИЛОЙ #wи $N3.",
			"$n С УЖАСАЮЩЕЙ СИЛОЙ #w$g Вас."
		}, {
			"$n СМЕРТЕЛЬНО #w$g $N3.",	/* 201+  14 */
			"Вы СМЕРТЕЛЬНО #wи $N3.",
