...
void dam_message(int dam, CHAR_DATA * ch, CHAR_DATA * victim, int w_type)
{
	...
	static struct dam_weapon_type {
...

		{
			...
			"$n БОЛЬНО #w$g $N3.",	/*  36..60   8 */
			"Вы БОЛЬНО #wи $N3.",
			"$n БОЛЬНО #w$g Вас."
		}, {
			"$n ОЧЕНЬ БОЛЬНО #w$g $N3.",	/*    61..100  9  */
			"Вы ОЧЕНЬ БОЛЬНО #wи $N3.",
			"$n ОЧЕНЬ БОЛЬНО #w$g Вас."
		}, {
			"$n ЧРЕЗВЫЧАЙНО БОЛЬНО #w$g $N3.",	/*   101..140  10 */
			"Вы ЧРЕЗВЫЧАЙНО БОЛЬНО #wи $N3.",
			"$n ЧРЕЗВЫЧАЙНО БОЛЬНО #w$g Вас."
		}, {
			"$n НЕВЫНОСИМО БОЛЬНО #w$g $N3.",	/*    141..180  11 */
			"Вы НЕВЫНОСИМО БОЛЬНО #wи $N3.",
			"$n НЕВЫНОСИМО БОЛЬНО #w$g Вас."
		}, {
			"$n СТРАШНО #w$g $N3.",	/*    181..220  12 */
			"Вы СТРАШНО #wи $N3.",
			"$n СТРАШНО #w$g Вас."
		}, {
			"$n УЖАСНО #w$g $N3.",	/*    221..260  13 */
			"Вы УЖАСНО #wи $N3.",
			"$n УЖАСНО #w$g Вас."
		}, {
			"$n ЗВЕРСКИ #w$g $N3.",	/*    261..300  14 */
			"Вы ЗВЕРСКИ #wи $N3.",
			"$n ЗВЕРСКИ #w$g Вас."
		}, {
			"$n УБИЙСТВЕННО #w$g $N3.",	/*    301..340  15 */
