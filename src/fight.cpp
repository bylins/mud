...
void dam_message(int dam, CHAR_DATA * ch, CHAR_DATA * victim, int w_type)
{
	...
	static struct dam_weapon_type {
...

		{
			...
			"$n легонько #w$g $N3.",	/*  1..10 1 */
			"Вы легонько #wи $N3.",
			"$n легонько #w$g Вас."
		}, {
			"$n слегка #w$g $N3.",	/*  11..20  2 */
			"Вы слегка #wи $N3.",
			"$n слегка #w$g Вас."
		}, {
			"$n #w$g $N3.",	/*  21..30   3 */
			...
			"$n сильно #w$g $N3.",	/* 41..50  5 */
			"Вы сильно #wи $N3.",
			"$n сильно #w$g Вас."
		}, {
			"$n очень сильно #w$g $N3.",	/*  51..60 6  */
			"Вы очень сильно #wи $N3.",
			"$n очень сильно #w$g Вас."
		}, {
			"$n чрезвычайно сильно #w$g $N3.",	/*  61..70  7 */
			"Вы чрезвычайно сильно #wи $N3.",
			"$n чрезвычайно сильно #w$g Вас."
		}, {
			"$n БОЛЬНО #w$g $N3.",	/*  71..115   8 */
			"Вы БОЛЬНО #wи $N3.",
			"$n БОЛЬНО #w$g Вас."
		}, {
			"$n ОЧЕНЬ БОЛЬНО #w$g $N3.",	/*    116..160  9  */
			"Вы ОЧЕНЬ БОЛЬНО #wи $N3.",
			"$n ОЧЕНЬ БОЛЬНО #w$g Вас."
		}, {
			"$n ЧРЕЗВЫЧАЙНО БОЛЬНО #w$g $N3.",	/*   161..205  10 */
			"Вы ЧРЕЗВЫЧАЙНО БОЛЬНО #wи $N3.",
			"$n ЧРЕЗВЫЧАЙНО БОЛЬНО #w$g Вас."
		}, {
			"$n НЕВЫНОСИМО БОЛЬНО #w$g $N3.",	/*    206..250  11 */
			"Вы НЕВЫНОСИМО БОЛЬНО #wи $N3.",
			"$n НЕВЫНОСИМО БОЛЬНО #w$g Вас."
		}, {
			"$n УЖАСНО #w$g $N3.",	/*    251..295  13 */
			"Вы УЖАСНО #wи $N3.",
			"$n УЖАСНО #w$g Вас."
		}, {
			"$n УБИЙСТВЕННО #w$g $N3.",	/*    296..340  15 */
			"Вы УБИЙСТВЕННО #wи $N3.",
			"$n УБИЙСТВЕННО #w$g Вас."
		}, {
			"$n СМЕРТЕЛЬНО #w$g $N3.",	/* 341+  16 */
			"Вы СМЕРТЕЛЬНО #wи $N3.",
